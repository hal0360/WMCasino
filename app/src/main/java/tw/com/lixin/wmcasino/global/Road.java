...
public class Road {
    public static final int Player = R.drawable.play_1;
    public static final int Player_B = R.drawable.play_2;
    public static final int Player_P = R.drawable.play_3;
    public static final int Player_P_B = R.drawable.play_4;
    public static final int Player_E = R.drawable.play_5;
    public static final int Player_B_E = R.drawable.play_6;
    public static final int Player_P_E = R.drawable.play_7;
    public static final int Player_P_B_E = R.drawable.play_8;
